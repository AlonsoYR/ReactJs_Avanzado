...
//const version = "app-compra-v3";

self.addEventListener('install', event => {
  console.log('Intalando una nueva version');
  self.registration.showNotification("Existe una nueva vesión de la App", { body: "Intalala ahora mismo" })
});
